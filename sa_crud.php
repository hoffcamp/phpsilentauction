...
class SA_CRUD_Column
{
	...
	function getInputID( $d ){ return 'input-' . $this->id; }
	function renderInput( $d ){
		$value = isset( $d[ $this->id ] ) ? $d[ $this-> id ] : '';
		echo "<input type=\"text\" id=\"".$this->getInputID($d)."\" value=\"{$value}\" class=\"regular-text\"/>";
	}
	function getInputValue( $d ){
		return $_GET[ 'input-' . $this->id ];
	}
}
...
?>
<form id="<?php echo $this-> formID; ?>" method="get">
<table class="wp-list-table widefat plugins">
	<thead>
	<tr>
		<td  id='cb' class='manage-column column-cb check-column'>
			<?php if ( $this-> includeCheckAll ): ?>
...
<?php
	...
	function renderInputForm( $d = array() ){
?>
<form id="<?php echo $this-> formID; ?>" method="get">
